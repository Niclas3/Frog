#ifndef _ARCH_X86_DESCRIPTOR_H
#define _ARCH_X86_DESCRIPTOR_H
...
extern void save_gdtr(Descriptor_REG *data);
extern void load_gdtr(Descriptor_REG *data);

// Set gdtr or idtr data
extern void save_idtr(Descriptor_REG *data);
extern void load_idtr(Descriptor_REG *data);
...
extern void create_gate(Gate_Descriptor *gd,
                 Selector selector,
                 Inthandle_t offset, // funtion
                 uint_8 attribute,
                 uint_8 dcount);

extern void create_descriptor(Segment_Descriptor *sd,
...
extern Segment_Descriptor* get_idt_base_address(void);
extern Segment_Descriptor* get_gdt_base_address(void);

extern void init_gdt(void);
extern void init_idt(void);

extern void create_tss(void);
