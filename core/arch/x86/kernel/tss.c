...
static void create_tss_descriptor(Segment_Descriptor *des_addr,
                                  uint_32 base,
                                  uint_32 limit,
                                  int dpl)
{
...
void create_tss(void)
{
        ...
        Selector sel_dat_ring0 =
            CREATE_SELECTOR(SEL_IDX_DATA_DPL_0, TI_GDT, RPL0);
...
{
        tss.esp0 = (uint_32 *) ((uint_32) thread + PAGE_SIZE);
}
